...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { category_id: @opportunity.category_id, contact: @opportunity.contact, location: @opportunity.location, name: @opportunity.name }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { category_id: @opportunity.category_id, contact: @opportunity.contact, location: @opportunity.location, name: @opportunity.name }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
