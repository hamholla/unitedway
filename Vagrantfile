...
def setup_environment
  return <<-EOS
    ...
    # Add shortcut alias 'uw' to change to project dir
    if ! grep -q 'alias uw=' $VAGRANT_HOME/.bashrc; then
      echo >> $VAGRANT_HOME/.bashrc
      echo 'alias uw="cd /vagrant"' >> $VAGRANT_HOME/.bashrc
    fi
  EOS
end
